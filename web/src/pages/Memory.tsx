...
export default function Memory() {
  ...
  const fetchEntries = (q?: string, cat?: string) => {
    ...
    getMemory(q || undefined, cat || undefined)
      ...
      .catch((err: unknown) => {
        ...
        setError(localizeErrorMessage(message, 'memory.load_error'));
      })
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : '';
      setFormError(localizeErrorMessage(message, 'memory.store_failed'));
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const handleDelete = async (key: string) => {
    try {
      ...
      const message = err instanceof Error ? err.message : '';
      setError(localizeErrorMessage(message, 'memory.delete_failed'));
    } finally {
